...
//   array_p_ffi_type_t *attrTypes;              // vector of attribute's
//   ffi_type array_CXTypeKind_t *attrUnderlyingType;     // array of CXTypeKind
...
//   array_p_Structure_t
//       *argsUnderlyingStructs;            // checking for proper struct
//       matching
//   array_p_Union_t *argsUnderlyingUnions; // checking for proper union
//   matching Structure *returnUnderlyingStruct;     // for type convertion
